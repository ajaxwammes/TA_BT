...
from services.utils.utils import analyst_ratings, risk
...
class PortfolioCreator:
    ...
    def portfolio_length(self,money_in_portfolio):
        portfolio_length = np.clip(round(money_in_portfolio/RTL.portfolio_length_variable),RTL.min_portfolio_length,RTL.max_portfolio_length)
